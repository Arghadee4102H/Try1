...
define('DB_SERVER', 'sql203.infinityfree.com');   // Example: sql101.infinityfree.com
define('DB_USERNAME', 'if0_39073218');      // Example: if0_12345678
define('DB_PASSWORD', 'Art454500');      // Your InfinityFree account password
define('DB_NAME', 'if0_39073218_watchclickearn_db'); // Example: if0_12345678_watchclickearn_db
